...
Bài toán này kết hợp giữa quản lý dữ liệu sản phẩm, xây dựng website.
## 3. Mục tiêu bài toán
### 3.1. Mục tiêu tổng quát
Xây dựng một hệ thống web có khả năng quản lý dữ liệu sản phẩm và hỗ trợ người dùng tiếp cận sản phẩm nhanh hơn thông qua chức năng hiển thị, tìm kiếm, lọc.
### 3.2. Mục tiêu cụ thể
...
- Người dùng cuối: tìm kiếm, xem, thêm giỏ hàng, đặt hàng sản phẩm.
